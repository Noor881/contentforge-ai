    ...
    try {
      const res = await fetch("/api/content/generate", {
        ...
        body: JSON.stringify({
          type: "ad_copy",
          params: formData,
          prompt: `Create ${formData.platform} ad copy for "${formData.product}" targeting ${formData.targetAudience}. Key benefit: ${formData.keyBenefit}. Include compelling CTA.`,
        }),
      });
    ...
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Create high-converting ad copy for all major platforms
        </p>
      </div>
          ...
          <CardContent>
            <form onSubmit={handleGenerate} className="space-y-6">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, keyBenefit: e.target.value })
                }
              />
