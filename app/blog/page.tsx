...
import { Calendar, User, Clock, ArrowRight, BookOpen, Pencil, MessageSquare, Mail, Video, Target, Search, Music } from 'lucide-react'
...
const categoryGradients: Record<string, string> = {
    'Tutorial': 'from-teal-500 to-cyan-400',
    'Strategy': 'from-blue-500 to-indigo-500',
    'Email Marketing': 'from-rose-500 to-pink-500',
    'Social Media': 'from-purple-500 to-violet-500',
    'Video Marketing': 'from-red-500 to-orange-500',
    'SEO': 'from-green-500 to-emerald-400',
    'Content Strategy': 'from-amber-500 to-yellow-400',
}
...
function getGradient(category: string): string {
    return categoryGradients[category] || 'from-primary-500 to-teal-400'
}
                        ...
                        <Link href={`/blog/${featuredPost.slug}`} className="block group">
                            <div className="glass-card overflow-hidden">
                                <div className="flex flex-col lg:flex-row">
                                    {/* Cover Image */}
                                    <div className={`relative lg:w-2/5 h-64 lg:h-auto bg-gradient-to-br ${getGradient(featuredPost.category)} flex items-center justify-center overflow-hidden`}>
                                    ...
                                    <div className="flex-1 p-8 lg:p-10">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                                                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary-500 to-teal-400 flex items-center justify-center text-white text-xs font-bold">
                                ...
                                return (
                                    <Link key={post.id} href={`/blog/${post.slug}`} className="block group">
                                        <div className="glass-card h-full overflow-hidden card-hover">
                                            {/* Gradient cover */}
                                            <div className={`relative h-44 bg-gradient-to-br ${getGradient(post.category)} flex items-center justify-center overflow-hidden`}>
                                                <div className="absolute inset-0 dot-grid opacity-20" />
                                                <div className="absolute inset-0 bg-gradient-to-t from-black/20 via-transparent to-transparent" />
                                            ...
                                            <div className="p-6 flex flex-col flex-grow">
                                                ...
                                                <div className="flex items-center justify-between text-sm pt-4 border-t border-gray-100 dark:border-gray-800">
                                                    <div className="flex items-center gap-2">
                                                        <div className={`w-6 h-6 rounded-full bg-gradient-to-br ${getGradient(post.category)} flex items-center justify-center text-white text-[10px] font-bold`}>
